              ...
              >
                {studyVideos.map((video) => (
                  <button
                    ...
                    className="group relative flex-none w-64 aspect-video rounded-xl overflow-hidden glass border border-white/10 hover:border-indigo-500/60 transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
                  >
                    <video
                      src={video.src}
                      preload="metadata"
